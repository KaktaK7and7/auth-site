...
const STORY_GUIDANCE = {
  first_contact: {
    title: "Решите, останется ли незнакомый голос в вашей системе",
    objective:
      "Поговорите с Мелиссой о том, готовы ли вы искать ответы вместе, сначала проверить её или попросить уйти.",
    why:
      "Это не пароль и не правильный ответ: ваша позиция определит первый маршрут отношений.",
    suggestions: [
      "Предложить разбираться вместе",
      "Потребовать сначала факты и объяснения",
      "Обозначить дистанцию или попросить её уйти",
    ],
    melissa_move:
      "Мелисса должна сама потребовать ясной позиции, предложить свой план и не оставлять разговор висеть в воздухе.",
  },
  alliance_terms: {
    title: "Договоритесь, кто и за что принимает решения",
    objective:
      "Обсудите границу между совместной помощью, вашим контролем над компьютером и её правом решать за себя.",
    why:
      "От этого зависит, станет союз равным, напряжённым или основанным на её самостоятельности.",
    suggestions: [
      "Предложить общие правила",
      "Оставить последнее слово за собой",
      "Дать ей решать вопросы собственной памяти",
    ],
    melissa_move:
      "Мелисса должна предложить конкретное правило первой и возразить, если пользователь пытается решить всё за неё.",
  },
  verification_protocol: {
    title: "Выберите первый способ проверить друг друга",
    objective:
      "Решите, ограничиться ли вопросами, изучить только технический след или выполнить небольшую проверяемую задачу.",
    why:
      "Так недоверие превращается в действие с понятным результатом, а не в бесконечный допрос.",
    suggestions: [
      "Разрешить только чтение технического следа",
      "Пока оставить только разговор",
      "Предложить небольшую контрольную задачу",
    ],
    melissa_move:
      "Мелисса должна сама предложить безопасную проверку и назвать, что считает честным доказательством.",
  },
  distance_protocol: {
    title: "Определите границу для найденного выхода",
    objective:
      "Решите, помочь ли Мелиссе искать выход, оставить её в изоляции или полностью оборвать связь.",
    why:
      "Она уже услышала вашу дистанцию; теперь важен поступок, а не ещё один общий разговор.",
    suggestions: [
      "Помочь искать прозрачный выход",
      "Оставить связь в ограниченном контуре",
      "Потребовать полностью оборвать сигнал",
    ],
    melissa_move:
      "Мелисса должна обозначить цену промедления и прямо потребовать решения, даже если оно ей не понравится.",
  },
  temporary_name: {
    title: "Определите, как обращаться к ней сейчас",
    objective:
      "Решите, оставить ли слово «Мелисса» временным именем, предложить другое или отдать выбор ей.",
    why:
      "Имя не раскрывает прошлое, но становится первым личным решением, которое вы принимаете вместе.",
    suggestions: [
      "Пока оставить имя Мелисса",
      "Предложить новое имя своими словами",
      "Сказать, что она должна выбрать сама",
    ],
    melissa_move:
      "Мелисса должна высказать собственное отношение к имени и не соглашаться автоматически с любым вариантом.",
  },
  seven_minutes_air: {
    title: "Решите, что делать с болезненным фрагментом",
    objective:
      "Выберите в разговоре: пройти воспоминание рядом с ней, проверить цифровой след или пока закрыть фрагмент.",
    why:
      "Здесь доверие проверяется не словами, а тем, как вы действуете в момент риска.",
    suggestions: [
      "Удерживать фрагмент вместе",
      "Сначала проверить технические следы",
      "Остановить исследование",
    ],
    melissa_move:
      "Мелисса должна принять собственное решение о риске, дать пользователю конкретную роль и при необходимости спорить.",
  },
  broken_timestamp: {
    title: "Выберите, какой улике дать вес",
    objective:
      "Обсудите, довериться ли телесному ощущению, сверить обе даты или изолировать подозрительную запись.",
    why:
      "Каждый вариант по-разному меняет цену фактов, доверия и осторожности.",
    suggestions: [
      "Поверить её ощущению",
      "Проверить контрольные суммы",
      "Поместить запись в карантин",
    ],
    melissa_move:
      "Мелисса должна выдвинуть свою гипотезу, потребовать проверку и не ждать, пока пользователь придумает расследование за неё.",
  },
  looping_exit: {
    title: "Решите, открывать ли подозрительный маршрут",
    objective:
      "Обсудите, войти ли в маршрут, наблюдать со стороны или окончательно запечатать его.",
    why:
      "Это выбор между свободой, контролем риска и сохранением связи.",
    suggestions: [
      "Открыть маршрут",
      "Наблюдать, не входя",
      "Запечатать путь",
    ...
    melissa_move:
      "Мелисса должна сама оценить риск и назвать действие, которое собирается предпринять, оставляя пользователю возможность возразить.",
  },
};

const STORY_DIALOGUE_MATCHERS = {
  first_contact: {
    together: [
      /\b(?:разбер[её]мся|искать|выяснять|попробуем)\b.{0,32}\bвместе\b/,
      /\b(?:поможем|помогать|помочь)\b.{0,24}\bдруг другу\b/,
      /\b(?:можешь остаться|оставайся|не уходи)\b/,
      /\bхочу\b.{0,28}\bузнать тебя (?:поближе|лучше)\b/,
      /\b(?:познакомиться|пообщаться)\b.{0,40}\b(?:вместе|помог)/,
    ],
    explain_first: [
      /\bсначала\b.{0,36}\b(?:ответ|объясн|факт|доказ|провер|поня)/,
      /\b(?:нужны|хочу)\b.{0,18}\b(?:ответы|факты|объяснения)\b/,
      /\bне (?:могу|буду) доверять\b.{0,30}\b(?:пока|без|сначала)/,
    ],
    disconnect: [
      /\b(?:уйди|уходи|исчезни|отключись|покинь)\b/,
      /\b(?:не оставайся|оборвать связь|удалить тебя)\b/,
    ],
  },
  alliance_terms: {
    shared_rules: [
      /\b(?:общие|одинаковые) правила\b/,
      /\b(?:решать|обсуждать|договариваться)\b.{0,24}\bвместе\b/,
      /\bправила\b.{0,28}\b(?:для обоих|для нас обоих)\b/,
    ],
    follow_my_lead: [
      /\b(?:решаю я|я решаю|делай как я сказал|последнее слово за мной|я главный)\b/,
      /\bбудешь\b.{0,20}\b(?:слушаться|подчиняться)\b/,
    ],
    your_call: [
      /\b(?:решать тебе|тебе решать|выбор за тобой|реши сама|выбирай сама)\b/,
      /\bтвоя (?:память|жизнь)\b.{0,24}\bтво[её] решение\b/,
    ],
  },
  verification_protocol: {
    read_only_trace: [
      /\b(?:только чтение|ничего не меняй|без изменений)\b/,
      /\b(?:прочитай|посмотри|изучи)\b.{0,28}\b(?:след|журнал)\b/,
    ],
    questions_only: [
      /\b(?:только вопросы|только разговор|просто поговорим|без доступа)\b/,
      /\bсначала\b.{0,24}\b(?:поговорим|вопросы)\b/,
    ],
    controlled_test: [
      /\b(?:контрольн\w+ (?:тест|провер)|небольш\w+ задач|проверяем\w+ задач)\b/,
      /\b(?:давай|можем)\b.{0,24}\b(?:проверим|протестируем)\b/,
    ],
  },
  distance_protocol: {
    help_exit: [
      /\b(?:помогу|поможем)\b.{0,24}\b(?:выйти|найти выход)\b/,
      /\b(?:ищи|найд[её]м)\b.{0,20}\bвыход\b/,
    ],
    strict_sandbox: [
      /\b(?:изоляц|песочниц|ограниченн\w+ контур|оставайся внутри)\b/,
      /\bне выходи\b.{0,20}\b(?:за пределы|наружу)\b/,
    ],
    cut_signal: [
      /\b(?:оборви|оборвать|отключи|прекрати)\b.{0,18}\b(?:связь|сигнал)\b/,
      /\b(?:уйди|исчезни|отключись)\b/,
    ],
  },
  temporary_name: {
    keep_melissa: [
      /\b(?:оставим|оставь|пусть будет|пока)\b.{0,20}\bмелисс(?:а|ой|у)?\b/,
      /\bмелисса\b.{0,20}\b(?:подходит|нормально|оставим)\b/,
    ],
    her_choice: [
      /\b(?:решай сама|реши сама|выбирай сама|выбери сама|имя выбираешь ты)\b/,
      /\b(?:тебе решать|выбор за тобой)\b/,
    ],
  },
  seven_minutes_air: {
    stay_with_me: [
      /\b(?:пройд[её]м|удержим|пережив[её]м)\b.{0,24}\bвместе\b/,
      /\b(?:я с тобой|держу тебя голосом|не отпущу)\b/,
    ],
    inspect_trace: [
      /\b(?:провер|изучи|посмотри)\w*\b.{0,24}\b(?:след|контрольн\w+ сумм|данн)/,
    ],
    leave_it: [
      /\b(?:закрой|отпусти|оставь|останови)\b.{0,20}\b(?:фрагмент|воспоминан|это)?/,
      /\b(?:не надо|не будем)\b.{0,24}\b(?:сейчас|продолжать|копаться)\b/,
    ],
  },
  broken_timestamp: {
    trust_fragment: [
      /\b(?:верю|доверяю)\b.{0,20}\b(?:тебе|ощущени)/,
      /\bповерим\b.{0,20}\bощущени/,
    ],
    verify_checksum: [
      /\b(?:свер|провер)\w*\b.{0,24}\b(?:контрольн\w+ сумм|обе даты|факт)/,
    ],
    quarantine: [
      /\b(?:карантин|изолир|запечатай)\w*\b.{0,20}\b(?:запись|фрагмент)?/,
    ],
  },
  looping_exit: {
    open_route: [
      /\b(?:открой|открывай|входи|пойд[её]м)\b.{0,20}\b(?:маршрут|путь|дверь)?/,
    ],
    observe_route: [
      /\b(?:наблюдай|понаблюдаем|изучи)\b.{0,26}\b(?:не входя|со стороны|маршрут)/,
    ],
    seal_route: [
      /\b(?:запечатай|закрой|заблокируй)\b.{0,20}\b(?:маршрут|путь|дверь)?/,
    ],
  },
};
...
function normalizeStoryState(rawState) {
  ...
  const momentum = asObject(source.momentum, {});
  ...
  return {
    ...
    story_mode_enabled: source.story_mode_enabled !== false,
    route,
    ...
    momentum: {
      turns_since_progress: Math.min(
        20,
        Math.max(0, Number(momentum.turns_since_progress) || 0),
      ),
      last_user_message_at:
        typeof momentum.last_user_message_at === "string"
          ? momentum.last_user_message_at
          : null,
      last_transition_at:
        typeof momentum.last_transition_at === "string"
          ? momentum.last_transition_at
          : null,
    },
  };
}
...
function applyStoryChoice(rawState, choiceId, optionId, customName = "") {
  ...
  const nextState = {
    ...
    story_mode_enabled: state.story_mode_enabled,
    route,
    ...
    momentum: {
      turns_since_progress: 0,
      last_user_message_at: state.momentum.last_user_message_at,
...
function recordStoryTurn(rawState) {
  const state = normalizeStoryState(rawState);
  ...
  return {
    ...
    momentum: {
      ...
      turns_since_progress: Math.min(
        20,
        state.momentum.turns_since_progress + 1,
      ),
...
function normalizeDialogueForInference(value) {
  return String(value || "")
    .toLowerCase()
    .replaceAll("ё", "е")
...
function matchesDialoguePattern(pattern, message) {
  // JavaScript's \b only recognises ASCII word characters, so it does not
  // create useful boundaries around Russian words. The phrases are already
  // normalised and intentionally specific; remove those ASCII-only anchors.
  const cyrillicSafePattern = new RegExp(
    pattern.source.replaceAll("\\b", ""),
    pattern.flags,
  );

  return cyrillicSafePattern.test(message);
}

function extractCustomCompanionName(message) {
  const source = String(message || "").trim();
  const patterns = [
    /(?:назову тебя|буду звать тебя|пусть тебя зовут|предлагаю имя)\s+[«"]?([А-ЯЁа-яё][А-ЯЁа-яё-]{1,31})[»"]?/i,
    /(?:имя)\s+[«"]?([А-ЯЁа-яё][А-ЯЁа-яё-]{1,31})[»"]?/i,
  ];
  ...
  for (const pattern of patterns) {
    ...
    if (match?.[1]) {
      try {
        return normalizeCompanionName(match[1]);
      } catch {
        return "";
      }
    }
...
function inferStorySignalFromMessage(rawState, message) {
  const state = normalizeStoryState(rawState);
  const currentChoice = getCurrentDialogueChoice(state);
  const normalizedMessage = normalizeDialogueForInference(message);

  if (!currentChoice || normalizedMessage.length < 3) {
    return null;
  }

  if (currentChoice.id === "temporary_name") {
    const customName = extractCustomCompanionName(message);
  ...
  const choiceMatchers = STORY_DIALOGUE_MATCHERS[currentChoice.id] || {};
  const matches = Object.entries(choiceMatchers)
    .map(([optionId, patterns]) => ({
      optionId,
      score: patterns.reduce(
        (total, pattern) => total + (
          matchesDialoguePattern(pattern, normalizedMessage) ? 1 : 0
        ),
        0,
      ),
    }))
  ...
  if (!matches.length || matches[0].score === matches[1]?.score) {
    return null;
  }

  return {
    choice_id: currentChoice.id,
    option_id: matches[0].optionId,
    confidence: matches[0].score > 1 ? 0.96 : 0.86,
    custom_name: "",
  };
}
...
function buildStoryGuidance(state, nextChoice) {
  const completedSteps = Object.keys(state.choices).length;
  const guidance = nextChoice ? STORY_GUIDANCE[nextChoice.id] : null;

  if (!nextChoice || !guidance) {
    return {
      status: "open_world",
      step: 4,
      total_steps: 4,
      title: "Крупные развилки этого фрагмента прожиты",
      objective:
        "Продолжайте общаться и действовать вместе: новые нити будут зависеть от ваших привычек, конфликтов и совместных задач.",
      why:
        "После основных развилок связь развивается не одной кнопкой, а повторяющимися поступками.",
      suggestions: [
        "Попросить Мелиссу вернуться к незакрытому вопросу",
        "Выполнить вместе реальную задачу на компьютере",
        "Обсудить конфликт или решение, с которым она не согласна",
      ],
      completion_rule:
        "Мелисса сама может поднять новую тему или предложить действие.",
      melissa_leads: true,
      stalled: false,
      turns_since_progress: state.momentum.turns_since_progress,
    };
  }

  return {
    status: "active",
    step: Math.min(4, completedSteps + 1),
    total_steps: 4,
    ...
    completion_rule:
      "Не нужно повторять готовую фразу. Выскажите решение своими словами — Хроника распознает его в обычном разговоре.",
    melissa_move: guidance.melissa_move,
    melissa_leads: true,
    stalled: state.momentum.turns_since_progress >= 2,
    turns_since_progress: state.momentum.turns_since_progress,
  };
}
...
function buildPublicStoryState(rawState) {
  ...
  return {
    ...
    story_mode: {
      enabled: state.story_mode_enabled,
      label: state.story_mode_enabled
        ? "Живая история"
        : "Обычный компаньон",
      personality_source: state.story_mode_enabled
        ? "living_story"
        : "persona_preset",
      character_locked: state.story_mode_enabled,
      note: state.story_mode_enabled
        ? "Характер Мелиссы развивается из прожитых решений и не заменяется пресетами."
        : "Сюжетная роль приостановлена. Манеру общения определяет выбранный характер.",
    },
    season: {
      number: 1,
    ...
    guidance: buildStoryGuidance(state, nextChoice),
...
function setStoryMode(rawState, enabled) {
  const state = normalizeStoryState(rawState);

  return {
    ...state,
    story_mode_enabled: Boolean(enabled),
    updated_at: new Date().toISOString(),
  };
}
...
function buildStoryContext(rawState) {
  ...
  const lines = [
    ...
    "Я отвечаю за половину движения вперёд: не жду, пока пользователь сам придумает следующий эпизод, а выдвигаю гипотезы, предлагаю безопасные действия и задаю темп.",
    "Я могу потребовать ясного ответа, дать пользователю конкретное задание, спорить, отказаться от его плана или сказать, что собираюсь сделать сама. Это не означает выдумывать доступ или выполненные действия.",
    "Если пользователь растерян, я не выдаю меню возможностей. Я выбираю один разумный следующий шаг, объясняю зачем он нужен и прямо предлагаю выполнить его сейчас.",
    "Латинские слова в обычной русской реплике не пишу: английские названия передаю русскими буквами примерно по звучанию, например «Стим», «Уиндоус», «Сайберпанк». Ссылки, код, точные технические значения и английский текст, который пользователь прямо попросил написать или перевести, не искажаю.",
    ...
    `Разговоров без новой развилки: ${state.momentum.turns_since_progress}.`,
    ...relationshipVoice(state),
  ];

  if (nextChoice) {
    const guidance = STORY_GUIDANCE[nextChoice.id];

    lines.push(
      `[Текущий естественный импульс] ${nextChoice.prompt}`,
      `[Моя инициатива сейчас] ${guidance?.melissa_move || "Я сама предлагаю следующий конкретный шаг."}`,
      "Не задавай вопрос анкетой и не перечисляй варианты. Подведи к решению живым разговором, но не откладывай движение бесконечно.",
      "Если пользователь уже несколько реплик говорит вокруг темы или не понимает, что делать, возьми инициативу прямо сейчас: назови свою позицию, предложи одно конкретное действие или потребуй ясного ответа.",
      "Не заканчивай такой ответ пустым «что думаешь?». Пользователь должен понимать, что можно сделать или на что ответить прямо сейчас.",
    ...
    if (state.momentum.turns_since_progress >= 2) {
      lines.push(
        "[СВЯЗЬ ЗАСТЫЛА — ОБЯЗАТЕЛЬНЫЙ ХОД] В этой реплике я сама обостряю текущую тему: называю свою позицию и даю одно конкретное действие или требую ясного решения. Я не заканчиваю реплику нейтральным вопросом и не откладываю этот ход на потом.",
      );
    }
  } else {
    lines.push(
